...
<head>
    ...
    <style>
        ...
        h2 { color: #b91c1c; font-size: 13px; margin-top: 4px; }
...
<body>
    @include('pdf.partials.header', ['title' => 'Job Order Report', 'logoBase64' => $logoBase64 ?? null])
